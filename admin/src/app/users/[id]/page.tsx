      ...
      <div className="mt-4 flex flex-col xl:flex-row gap-8">
        ...
        <div className="w-full xl:w-1/3 space-y-6">
          ...
          <div className="bg-primary-foreground p-4 rounded-lg space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Vel voluptas distinctio ab ipsa commodi fugiat
              labore quos veritatis cum corrupti sed repudiandae ipsum, harum recusandae ratione ipsam in, quis quia.
            </p>
          </div>
